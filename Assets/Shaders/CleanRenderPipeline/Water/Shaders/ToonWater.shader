    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings input) : SV_Target
            {
                ...
                half foamAlpha = combinedFoam * _FoamColor.a;
                finalColor = lerp(finalColor, _FoamColor.rgb, foamAlpha);
                ...
                half finalAlpha = saturate(lerp(_ShallowColor.a, 1.0, foamAlpha));
